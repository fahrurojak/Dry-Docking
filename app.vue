        ...
        <div class="waves-container">
          <svg class="waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shape-rendering="auto">
            ...
            <g class="parallax">
              ...
              <use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(255,255,255,0.45)" />
              <use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(255,255,255,0.65)" />
...
.splash-screen {
  ...
  width: 100vw;
  height: 100vh;
  background: linear-gradient(135deg, #38bdf8 0%, #0ea5e9 100%); /* Bright clean sky blue */
  display: flex;
